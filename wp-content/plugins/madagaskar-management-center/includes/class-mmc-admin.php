...
class MMC_Admin {
    ...
    public function region_data_page() {
        ...
        <div class="wrap mmc-wrap">
            ...
            <?php $this->notice_from_query(); ?>
            <p class="mmc-lead">İl/ilçe toplam nüfusu Madagaskar Nüfus Verisi kaynağından otomatik okunur. Okul ana listesi Madagaskar → Okul Tanıtım'dan gelir. Bu ekran yalnız otomatik kaynakta bulunmayan yaş/eğitim gibi ek metrikler içindir.</p>
            <div class="mmc-cards">
